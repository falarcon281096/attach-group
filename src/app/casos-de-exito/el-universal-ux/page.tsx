        ...
        <div className="bg-linear-to-r from-[#1e3fda] to-[#58308c] rounded-b-[30px] lg:rounded-b-[50px] relative z-10">
          <div className="rounded-b-[50px] mx-7 lg:mx-30 pt-25 lg:pt-17 pb-0 lg:pb-16">
            <div className="flex pt-0 md:pt-10 flex-col lg:flex-row gap-8 lg:gap-20 items-start mt-0 md:mt-0">
              ...
              >
                ...
                >
                  El Universal integra IA conversacional
                </p>
                <h1
                ...
                <p
                  className={`pt-0 md:pt-90 lg:pt-0 text-l lg:text-xl text-white mb-0 ms:mb-0 max-w-lg transform transition-all duration-1000 delay-400 ${
                    isVisible["hero-content"]
                      ? "opacity-100 translate-x-0"
                      : "opacity-100 -translate-x-10"
                  }`}
                >
                  Con más de un siglo de historia, El Universal es uno de los
                  periódicos más influyentes de México y un referente regional
                  por su cobertura política, económica y cultural. Su reputación
                  se basa en la rigurosidad editorial y en la confianza de sus
                  lectores, valores que ha sabido mantener mientras avanza hacia
                  lo digital.
                </p>
              </div>
              ...
              >
                <div className="pt-0 md:pt-5 relative w-full z-0 overflow-hidden rounded-[1.25rem] lg:rounded-l-[4rem] lg:rounded-r-none group">
                  <Image
                    ...
                    src="/images/casos-de-exito/universal/EL-UNIVERSAL-1.webp"
          ...
          <section className="">
            <div className="text-white mx-7 lg:mx-30 pt-0 pb-15 lg:py-16 grid grid-cols-2 lg:grid-cols-4 lg:gap-2 gap-y-10">
              ...
              >
                <p className="font-bold text-l lg:text-3xl transform transition-all duration-500 group-hover:scale-110 group-hover:translate-x-6">
                  Chatbot conversacional en español
                </p>
              </div>
              {/* Indicador 2 */}
              <div
              ...
              >
                <p className="font-bold text-l lg:text-3xl transform transition-all duration-500 group-hover:scale-110 group-hover:translate-x-6">
                  Benchmark de 7 modelos de lenguaje
                </p>
              </div>
              {/* Indicador 3 */}
              <div
      ...
      <section className="bg-white lg:rounded-b-[50px] rounded-b-[30px] pt-7 pb-0 px-7 lg:pt-30 lg:pb-10">
        <div className="flex gap-10 lg:mx-30 pb-15 lg:flex-row flex-col justify-items-stretch">
          ...
          >
            ...
            <p className="tex-xl text-gray-600">
              El desafío planteado era claro: crear una interfaz conversacional
              impulsada por un LLM que permitiera a los lectores conversar en
              español sobre las noticias en tiempo real. La innovación debía
              estar al servicio de la audiencia, pero sin comprometer la
              precisión editorial ni la confianza que la marca ha construido a
              lo largo de décadas.
            </p>
          </div>
          <div
        ...
        <div className="flex gap-10 lg:gap-15 lg:mx-30 pb-20 lg:flex-row flex-col justify-items-stretch">
          ...
          >
            ...
            <p className="tex-xl text-gray-600">
              Para abordar este reto, aplicamos nuestro enfoque experto y
              metodológico:
            </p>
            <br />
            <p
            ...
            >
              <b>1. Empatizar primero: </b> realizamos entrevistas en
              profundidad con directivos, editores y usuarios para comprender
              tanto los objetivos de negocio como las normas éticas y las
              necesidades reales de consumo de información.
            </p>
            <br />
            ...
            >
              <b>2. Comparar y medir: </b> analizamos diferentes modelos de
              lenguaje (ChatGPT, Claude, DeepSeek, Grok, Meta AI, Microsoft
              Copilot y Gemini), evaluando comprensión, factualidad,
            ...
            >
              <b>- BigQuery Notebooks: </b>Permitió automatizar procesos
              mediante código directamente en la misma base de datos, sin
              necesidad de mover la información a otras herramientas.
              <br />
            </p>
            ...
            >
              <b>- Diseñar con propósito: </b> consolidamos los hallazgos en
              formatos conversacionales claros y seguros, que reflejaran la voz
              periodística de El Universal.
            </p>
            <br />
            ...
            >
              <b>3. Prototipar la experiencia completa: </b> diseñamos un
              sistema visual accesible y responsive, y creamos un prototipo
              end-to-end en Figma.
            </p>
            <br />
            ...
            <p
              ...
              className={`tex-xl text-gray-600 transform transition-all duration-1000 delay-700 ${
                isVisible["estrategia-p6"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              <b>4. Asegurar continuidad técnica: </b> entregamos un hand-off
              completo con tokens, especificaciones y flujos, listos para su
              implementación.
            </p>
          </div>
        </div>
