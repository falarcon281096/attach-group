  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-[#1e3fda] to-[#58308c] relative overflow-hidden">
        ...
        <div className="bg-linear-to-r from-[#1e3fda] to-[#58308c] rounded-b-[30px] lg:rounded-b-[50px] relative z-10 overflow-hidden">
          ...
          <div className="rounded-b-[50px] lg:ml-27 lg:pt-27 pb-0 lg:pb-16 pt-25 md:pt-40 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center lg:ml-15">
              ...
              >
                ...
                <h1
                  className={`text-4xl lg:text-6xl font-bold mb-8 mr-4 transform transition-all duration-1000 delay-200 ${
                ...
                {/* Mobile Image - Visible only on mobile */}
                 <div
                  ref={(el) => setElementRef("hero-image-mobile", el)}
                  data-animate-id="hero-image-mobile"
                  className={`
                      block
                      lg:hidden
                      relative
                ...
                <p
                  className={`pt-0 lg:pt-0 text-l lg:text-xl text-white mb-8 max-w-lg transform transition-all duration-1000 delay-400 ${
                    isVisible["hero-content"]
                      ? "opacity-100 translate-x-0"
                      : "opacity-100 -translate-x-10"
                  }`}
                >
                  DepoSeguro es la primera cadena de self-storage en Perú,
                  especializada en el alquiler de depósitos y almacenes en Lima
                  desde 1m². Brinda soluciones tanto para empresas como para
                  personas naturales, y se destaca por su enfoque en seguridad
                  —con videovigilancia y control de humedad— y por ofrecer total
                  flexibilidad en tiempos y tamaños de renta.
                </p>
              </div>
          ...
          <section className="">
            <div className="text-white mx-7 lg:mx-30 pt-0 pb-15 lg:py-16 grid grid-cols-2 lg:grid-cols-3 lg:gap-2 gap-y-10">
              ...
              >
                <p
                  className="font-bold text-3xl lg:text-5xl transform transition-all duration-500 group-hover:scale-110 group-hover:translate-x-6"
                  style={
                    {
                ...
                <p className="mt-2 lg:text-xl text-l transform transition-all duration-500 delay-100 group-hover:translate-x-2">
                  en tasa de conversión web (YoY)
                </p>
              </div>
              {/* Indicador 2 */}
              <div
              ...
              >
                ...
                <p className="mt-2 lg:text-xl text-l transform transition-all duration-500 delay-100 group-hover:translate-x-2">
                  en contactabilidad promedio en anuncios digitales
                </p>
              </div>
              {/* Indicador 3 */}
              <div
                ...
                className={`relative px-7 border-l border-gray-200/60 before:content-[''] before:absolute before:left-0 before:top-[45%] before:-translate-y-[60%] before:w-[2px] before:h-17 before:bg-white transform transition-all duration-700 hover:scale-105 group ${
                  isVisible["indicator-3"]
                    ? "opacity-100 translate-y-0"
                    : "opacity-100 translate-y-10"
                }`}
                style={{ transitionDelay: "0.4s" }}
              >
                <p className="lg:mr-0 mr-[-196px] mt-2 lg:text-xl text-l transform transition-all duration-500 delay-100 group-hover:translate-x-2">
                  Rendimientos cercanos al puntaje máximo en Google PageSpeed y
                  óptimos en mobile.
                </p>
              </div>
            </div>
        ...
        <div className="flex gap-10 lg:mx-30 pb-15 lg:flex-row flex-col justify-items-stretch">
          ...
          >
            ...
            <div className="w-full md:w-[70%]">
              <p className="text-xl text-gray-600">
                DepoSeguro buscaba optimizar su sitio web para que dejara de ser
                solo un punto de contacto digital y se convirtiera en un canal
                estratégico para generar leads y potenciar su crecimiento
                comercial.
              </p>{" "}
              <br />
              <p className="text-xl text-gray-600">
                El desafío implicaba mejorar la experiencia de usuario,
                rediseñar la arquitectura tecnológica y elevar el rendimiento en
                velocidad, SEO y conversión, asegurando una transición fluida y
          ...
          <div
            ...
            className={` 
                    ...
                    lg:w-[50%]
                    transform transition-all duration-1000 delay-300
                    ${isVisible["reto-image"] ? "opacity-100" : "opacity-100 "}
              `}
          >
            <ImageWithCrossIcon
        ...
        <div className="flex gap-10 lg:gap-15 lg:mx-30 pb-20 lg:flex-row flex-col justify-items-stretch">
          ...
          >
            ...
            <p
              ...
              className={`text-xl text-gray-600 transform transition-all duration-1000 delay-200 ${
                isVisible["estrategia-p1"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              Desarrollamos una estrategia integral basada en cuatro pilares
              clave: diseño y experiencia de usuario, infraestructura
              tecnológica, escalabilidad y posicionamiento digital.
            </p>
            <br />
            <p
              ref={(el) => setElementRef("estrategia-p2", el)}
              data-animate-id="estrategia-p2"
              className={`text-xl text-gray-600 transform transition-all duration-1000 delay-300 ${
                isVisible["estrategia-p2"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              <b>1. Diagnóstico profundo y definición de objetivos: </b>
              Auditoría completa del sitio anterior —usabilidad, velocidad,
              arquitectura y SEO— complementada con investigación de usuarios y
              benchmarking competitivo. Esto nos permitió definir
              funcionalidades clave, flujos eficientes y KPIs alineados al
              negocio.
            </p>
            <br />
            <p
              ...
              className={`text-xl text-gray-600 transform transition-all duration-1000 delay-400 ${
                isVisible["estrategia-p3"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              <b>2. Diseño UX/UI y desarrollo web optimizado: </b>
              Diseñamos una experiencia centrada en el usuario, con enfoque
              mobile-first, interfaces intuitivas y navegación clara. El
              desarrollo fue realizado en WordPress utilizando tecnologías
              avanzadas, priorizando velocidad, seguridad y escalabilidad, y
              aplicando prácticas que aseguran un alto rendimiento en Google
              Page Speed.
            </p>
            <br />
            <p
              ...
              className={`text-xl text-gray-600 transform transition-all duration-1000 delay-500 ${
                isVisible["estrategia-p4"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              <b>3. SEO técnico y migración a Google Cloud Platform (GCP): </b>
              Construimos el sitio con una estructura semántica y URLs
              optimizadas desde su base. Además, migramos la infraestructura a
              GCP para garantizar disponibilidad, monitoreo continuo y capacidad
              de escalar de manera flexible según demanda.
            </p>
            <br />
            <p
              ref={(el) => setElementRef("estrategia-p5", el)}
              data-animate-id="estrategia-p5"
              className={`text-xl text-gray-600 transform transition-all duration-1000 delay-600 ${
                isVisible["estrategia-p5"]
                  ? "opacity-100 translate-y-0"
                  : "opacity-100 translate-y-10"
              }`}
            >
              <b>4. Lanzamiento controlado y mejora continua: </b>
              Realizamos pruebas exhaustivas antes del lanzamiento, seguimiento
              post-live y optimizaciones basadas en métricas reales de uso,
              conversión y posicionamiento. También brindamos soporte continuo
              con actualizaciones, mantenimiento y mejoras evolutivas.
            </p>
          </div>
        </div>
      ...
      <section className="pb-10 px-5 lg:pr-30 relative overflow-hidden">
        ...
        >
          <h2
            className="text-3xl md:text-4xl text-white lg:text-5xl font-bold max-w-2xl transform transition-all duration-700 "
            style={
              {
          ...
          >
            Conversemos{" "}
            <span className="ml-2 inline-block transform transition-transform duration-500 group-hover:translate-x-2">
              ➜
            </span>
          </a>
        </div>
