...
export default function Header({
  ...
  const getBackgroundGradient = () => {
    ...
    if (isAthena)
      return "bg-gradient-to-r from-[#E2E830] via-[#A1E05E] via-[#2ED3B1] to-[#00CED3]"
  ...
  const getButtonGradient = () => {
    ...
    if (isProspectia) return "bg-gradient-to-r from-[#0066cc] to-[#004499]"
  ...
  const getButtonTextColor = () => {
    ...
    if (isProspectia) return "text-[#FFC351]"
  ...
  return (
    <header
      className={`${
        isFixed ? "fixed" : "fixed lg:static"
      } z-60 top-0 left-0 right-0 z-50 lg:shadow-none min-h-[80px] lg:min-h-0 ${getBackgroundGradient()}`}
    >
      <div
        className={`w-full px-3 lg:px-4 lg:pl-15 flex items-center justify-between py-5 lg:py-4 ${
          showBorder
            ? isWhiteBg
              ? "lg:border-l-2 border-[#1e3fda]/20"
      ...
      >
        ...
        <nav className="hidden lg:flex items-center space-x-8 justify-center">
          ...
          >
            <button
              className={`hover:opacity-80 font-bold transition-all duration-300 ease-in-out flex items-center ${
                isWhiteBg ? "text-[#1e3fda]" : "text-white"
              }`}
            >
              Soluciones
            ...
            {/* Dropdown Menu */}
            <div
              className={`absolute top-full left-1/2 transform -translate-x-1/2 w-[620px] bg-white rounded-2xl border border-gray-100 z-50 transition-all duration-300 ease-in-out ${
            ...
            >
              <div className="p-6">
                <div className="grid grid-cols-2 gap-6 relative">
                  ...
                  <div className="pr-4">
                    <h3 className="text-lg font-bold text-[#1e3fda] mb-6">
                      Nuestras marcas
                    </h3>
                    <div className="">
                      {/* Galileo IA */}
                      ...
                      <hr
                        className="border-gray-100 my-2"
                        style={{ borderColor: "#9080c0" }}
                      />
                  ...
                  <div className="pl-4">
                    ...
                    <div className="">
                      {/* PRISMA */}
                      <Link href="/prisma" className="group cursor-pointer">
                        <div className="flex items-start justify-between px-4 py-2 rounded-lg hover:bg-gray-50 transition-all duration-200">
                          <div className="flex-1">
                            <div className="mb-2">
                              <Image
                      ...
                      {/* PROSPECTIA */}
                      <Link href="/prospectia" className="group cursor-pointer">
                        <div className="flex items-start justify-between px-4 py-2 rounded-lg hover:bg-gray-50 transition-all duration-200">
                          <div className="flex-1">
                            <div className="mb-2">
                              <Image
        ...
        {/* Mobile menu button */}
        <button
          className={`lg:hidden transition-all duration-300 ml-3 ${
            isWhiteBg ? "text-[#1e3fda]" : "text-white"
          }`}
              ...
              <div className="pb-4 border-b border-gray-200">
                ...
                >
                  <div className="mt-4 space-y-6">
                    {/* Nuestras marcas */}
                    <div>
                      <h3 className="text-[#1e3fda] text-lg font-bold mb-4">
                        Nuestras marcas
                      </h3>
