                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 scroll-reveal-right scroll-reveal-delay-1">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 ml-auto max-w-2xl">
                            {/* Card 1 - Audiencia */}
                            <div className="relative rounded-2xl md:rounded-3xl overflow-hidden h-48 md:h-64 flex items-end justify-center transform transition-all duration-700 hover:scale-105 ">
                                <Image
                            ...
                            <div className="relative rounded-2xl md:rounded-3xl overflow-hidden h-48 md:h-64 flex items-end justify-center transform transition-all duration-700 hover:scale-105  scroll-reveal-right scroll-reveal-delay-1">
                                <Image
                            ...
                            {/* Card 3 - Formato */}
                            <div className="relative rounded-2xl md:rounded-3xl overflow-hidden h-48 md:h-64 flex items-end justify-center sm:col-span-2 md:col-span-1 transform transition-all duration-700 hover:scale-105  scroll-reveal-right scroll-reveal-delay-2">
                                <Image
