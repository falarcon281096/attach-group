      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {stats.map((item, i) => (
          <div
            ...
            className={`bg-[#F7F7F7] rounded-2xl flex flex-col gap-2 p-6 relative transform transition-all duration-700 hover:scale-105 hover:-translate-y-2 group ${
              isVisible[`stat-${i}`]
                ? "opacity-100 translate-y-0"
                : "opacity-100 translate-y-10"
            }`}
          ...
          >
            ...
            >
              <h2
                className="text-2xl lg:text-3xl font-bold text-[#1840E2] transform transition-all duration-500 group-hover:scale-110 group-hover:translate-x-6"
                style={
                  {
